...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // Do NOT annotate these with @ExceptionHandler or @Override. Let Spring detect them from base class.

    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
                                                                  HttpHeaders headers,
                                                                  HttpStatus status,
                                                                  WebRequest request) {
        LOGGER.info("Start - Validation Exception");
        ...
        LOGGER.info("End - Validation Exception");
